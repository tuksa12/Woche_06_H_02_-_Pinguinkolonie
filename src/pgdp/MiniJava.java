...
public class MiniJava {
	...
	private static Random rand, randName = new Random(6055);
	...
	/**
	 * Returns a random name. This method uses a different RNG to not interfere with
	 * other random methods in MiniJava (specific to this homework).
	 * <p>
	 * <i>Gibt einen zufälligen Name zurück.</i>
	 */
	public static String generateName() {
		...
		for(int i = 0; i < 3; i++) {
			char consonant = consonants.charAt(randName.nextInt(consonants.length()));
			char vowel = vowels.charAt(randName.nextInt(vowels.length()));
			name.append(i == 0 ? Character.toUpperCase(consonant) : consonant);
			name.append(vowel);
		}
	 ...
	 * <p>
	 * <i>Gibt einen zufälligen Booleanwert zurück.</i>
	 */
	...
	/**
	 * Returns a random boolean with probability of <code>true</code> being 1/<code>trueChance</code>.
	 * <p>
	 * <i>Gibt einen zufälligen Booleanwert zurück, wobei
	 * die Wahrscheinlichkeit von <code>true</code> 1/<code>trueChance</code> entspricht.</i>
	 */
	public static boolean randomBoolean(int trueChance) {
		return randomInt(1, trueChance) == 1;
	}
